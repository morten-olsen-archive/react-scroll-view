...
var publicApi = ['addEventListener', 'removeEventListener', 'triggerEvent', 'getScrollContainer', 'scrollToTop', 'scrollToBottom', 'getDistanceToBottom', 'getDistanceToTop', 'enableScroll', 'disableScroll'];
...
var ScrollApi = function () {
  ...
  _createClass(ScrollApi, [{
    ...
    value: function getPublicApi() {
      ...
      var own = publicApi.reduce(function (output, key) {
        output[key] = _this4[key];
        return output;
      }, {});
      return _extends({}, own, baseApi);
    }
  }]);
